...
<body>
	<div class="theme-layout">
		<header>
			<div class="container">
				<div class="logo"><a href="index-2.html" title=""><img src="png/logo.png" alt="" /></a></div><!-- Logo -->
		...
		<div class="responsive-header">
			...
			<div class="responsive-logobar">
				<div class="responsive-logo"><a href="index-2.html" title=""><img src="png/logo.png" alt="" /></a></div>
								...
								<div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;">
									<ul>
										<li data-index="rs-1" data-transition="fade" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-title="Slide 1">
											...
											style="font-size:18px;letter-spacing:0.3px">Education Needs Complete Solution
											</div>				
											...
											data-responsive_offset="on"
											data-elementdelay="0.05"
											style="font-size:42px;letter-spacing:0.3px;line-height:45px">START LEARNING <span>TODAY!</span>
											</div>				
											...
											data-responsive_offset="on"
											data-elementdelay="0.05"
											style="font-size:16px;letter-spacing:0.3; line-height:28px">Join our community to get Updates and Special Offers. You can <br> unsubscribe at any time (we can still be friends)!”
											</div>
										...
										<li data-index="rs-2" data-transition="fade" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-title="Slide 2">
											...
											data-responsive_offset="on"
											data-elementdelay="0.05"
											style="font-size:42px;letter-spacing:0.3px;line-height:45px">REACH THEIR GOALS
											</div>				
					...
					<div class="row">
						<div class="col-md-12">
							<div class="title">
								...
								<span>Learn Form Best Staff</span>
							...
							<div class="button-set">
								...
								<a class="button" href="#" title="">View All Services</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="easyedu-counter">
								<div class="row">
									<div class="col-md-3">
										<div class="counter">
											<img src="png/edu-counter1.png" alt="" />
									...
									<div class="col-md-3">
										<div class="counter">
											<img src="png/edu-counter2.png" alt="" />
											<div class="counter-inner">
									...
									<div class="col-md-3">
										<div class="counter">
											<img src="png/edu-counter3.png" alt="" />
											<div class="counter-inner">
									...
									<div class="col-md-3">
										<div class="counter">
											<img src="png/edu-counter4.png" alt="" />
											<div class="counter-inner">
				...
				<div class="container">
					<div class="col-md-8">
						<div class="side-title">
							<span>Hot Topics In Our List Of Courses</span>
							<h2>Educational <i>Programs</i></h2>
						</div>
						<div class="educational-programs">
							<p>Vestibulum at magna tellus. Vivamus sagittis et nunc ut in orcialiquam, ac vulputa leo vehicula. Mauris  magna tellus vivamus sagittis et nunc. Duis aute irure dolor in reprehe nderit in voluptate velit esum do lore eu.Fugiat nulla pariatur. Duis aute irure dolor in reprehenderit involuptate velit esse.</p>
							<div class="row">
								<div class="col-md-6">
									<div class="program">
										<div class="prog-icon"><span><img src="png/prog1.png" alt="" /></span></div>
										<div class="prog-detail">
											<h4>Contemporary Art</h4>	
											<p>Vestibulum at magna tellus involuptate esse. Aenean egestas magna at.</p>
										</div>
									</div><!-- Program -->
								</div>
								<div class="col-md-6">
									<div class="program">
										<div class="prog-icon"><span><img src="png/prog2.png" alt="" /></span></div>
										<div class="prog-detail">
											<h4>Studies & Language</h4>	
											<p>Vestibulum at magna tellus involuptate esse. Aenean egestas magna at.</p>
										</div>
									</div><!-- Program -->
								</div>
								<div class="col-md-6">
									<div class="program">
										<div class="prog-icon"><span><img src="png/prog3.png" alt="" /></span></div>
										<div class="prog-detail">
											<h4>Law & Business</h4>	
											<p>Vestibulum at magna tellus involuptate esse. Aenean egestas magna at.</p>
										</div>
								...
								<div class="col-md-6">
									<div class="program">
										<div class="prog-icon"><span><img src="png/prog4.png" alt="" /></span></div>
										<div class="prog-detail">
					...
					<div class="col-md-4">
						<div class="mockup"><img src="png/books-mockup.png" alt="" /></div>
					</div>
				</div>
			</div>
		</section>
						...
						<div class="edu-event">
							...
							<div class="event-detail">
								...
								<div class="event-description">
									...
									<p>Estibulum orci felis, ullamcorper non condimentum ultrices ac nunc. Mauris non ligula suscipit, vulputa. Consectetur adipiscing elites. Nulla convallis egestas rhoncusa. Donec loremvel proin vestibulum.</p>
								</div>
						...
						<div class="col-md-4">
							<div class="widget">
								<div class="about-widget">
									<div class="widget-logo"><a href="index-2.html" title=""><img src="png/logo2-2.png" alt="" /></a></div>
